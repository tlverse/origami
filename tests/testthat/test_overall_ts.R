...
test_that("CV MSE matches previous value", expect_equal(mses_mean[[1]], 
...
test_that("CV MSE with gap and bacth matches previous value", expect_equal(mses_mean[[1]], 
                                                        6004.730, tolerance = 0.01))


#Tests with gap and batch parameters for rolling window CV:
folds = make_folds(AirPassengers, fold_fun=folds_rolling_window,
...
test_that("CV MSE with rolling window matches previous value", expect_equal(mses_mean[[1]], 
