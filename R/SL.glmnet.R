...
# this doesn't work yet because glmnet can pick different sets of lambdas - need
# to fix this
SL.glmnetall <- function(Y, X, newX, family, obsWeights, id, alpha = 1, nfolds = 10, 
    ...
    fit <- glmnet(x = X, y = Y, weights = obsWeights, lambda = NULL, family = family$family, 
