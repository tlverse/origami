...
#' @title Fold Helpers
#' @description Acessors/Indexers for the different parts of a fold.
#' @param x an object to be indexed by a training set, validation set, or fold index. If missing, the index itself will be returned.
#' @param fold Fold; the fold used to do the indexing. If missing, \code{fold} will be pulled from the calling environment, if available.
